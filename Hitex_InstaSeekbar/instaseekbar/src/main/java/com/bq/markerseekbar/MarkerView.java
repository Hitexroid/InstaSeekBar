...
public final class MarkerView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        markerPaint.setShader(new LinearGradient(0, 0, 0, getHeight(), getResources().getColor(R.color.purple), getResources().getColor(R.color.red), Shader.TileMode.MIRROR));
